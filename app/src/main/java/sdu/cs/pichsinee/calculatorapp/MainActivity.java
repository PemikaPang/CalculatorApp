package sdu.cs.pichsinee.calculatorapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button subtractButton = findViewById(R.id.btSubtract);
        Button multiplyButton = findViewById(R.id.btMultiply);
        Button divideButton = findViewById(R.id.btDivide);
